...
var _format2 = __webpack_require__(4);
...
var internalGa = function internalGa() {
  ...
  if (!window.ga && process.env.NODE_ENV === 'production') return (0, _warn2.default)('ReactGA.initialize must be called first or GoogleAnalytics should be loaded manually');
